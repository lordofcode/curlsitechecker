...
class MySQL
{
  ...
  // Custom Functions
	...
	/**
	 * This function returns the last query as an XML Document
	 *
        ...
        $xml .= "\n<Root Status=\"ok\">\n";
          ...
          $i = 0;
            ...
            $i++;
				...
				$xml = '<?xml version="1.0" encoding="UTF-8"?><Root Status="failure" />';
			}
		} else {
			$this->active_row = -1;
			$xml = '<?xml version="1.0" encoding="UTF-8"?><Root Status="failure" />';
	...
	/**
	 * This function returns the last query as an JSON Document
	 *
